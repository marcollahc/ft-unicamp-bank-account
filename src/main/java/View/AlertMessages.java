 ...
 */
public class AlertMessages extends javax.swing.JFrame {    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertMessages.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlertMessages().setVisible(true);
            }
        });
    }
    ...
    public void updateMessage() {
        jLabel1.setText(this.getMessageAlert());
    }
